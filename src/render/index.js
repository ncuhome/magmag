...
/**
 * Modified from https://github.com/liabru/matter-js/blob/master/src/render/Render.js
 */

import { Bounds, Common, Composite, Events, Mouse, Vector } from 'matter-js'
...
(function () {
  ...
  Render.performance = function (render, context) {
    ...
    const elapsedMean = _mean(elapsedHistory)
    const engineDeltaMean = _mean(engineDeltaHistory)
    const engineElapsedMean = _mean(engineElapsedHistory)
    const timestampElapsedMean = _mean(timestampElapsedHistory)
